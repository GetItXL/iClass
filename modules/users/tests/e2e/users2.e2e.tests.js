...
describe('student E2E Tests:', function () {
  // var user1 = {
  //   firstName: 'professor',
  //   lastName: 'user',
  ...
  describe('Signup Validation', function () {
    ...
    it('should be able to sleep for 100000 ms', function()  {
        browser.sleep(15000);
    });
    ...
    it('Should report invalid email address - "123@123.com"', function () {
      ...
      element(by.model('credentials.lastName')).sendKeys(user2.lastName);
      // Enter Email
      element(by.model('credentials.email')).sendKeys('123@123.com');
      // select userrole
      ...
      element(by.css('button[type=submit]')).click();
      // Email address error
      expect(element.all(by.css('strong')).get(0).getText()).toBe('Please fill a valid email address');
    });
